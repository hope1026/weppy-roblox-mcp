...
👉 [Guia de instalação do plugin](https://weppy-web.pages.dev/en/install#plugin)
...
👉 [Guia de instalação do WROX Roblox Explorer](https://weppy-web.pages.dev/en/install#explorer)
